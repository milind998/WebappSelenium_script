...
Feature: Users Page
@tag81
Scenario Outline: Navigating to Users page
...
@tag83
Scenario Outline: Search valid User by phone number
...
@tag93_
Scenario Outline: User Redeem request Send request without pan and no.of waterdrop
...
###############one time use
@tag95
Scenario Outline: Edit User custom price settings for one time use
When click on product button
...
@tag96
Scenario Outline: Edit User custom price settings Refill
When click on product button
And Select the product from dropdown
And Click on add product button
...
##########Both
@tag97
Scenario Outline: Edit User custom price settings both
When click on product button
And Select the product from dropdown
And Click on add product button
...
@tag98
Scenario Outline: Set Addresscustom price settings One time sale
...
@tag99
Scenario Outline: Set the Address level custom price settings for Refill sale
When Click on the product details button
And Select the product from dropdown
And Click on add product button
And Select the Refill toggle button
...
@tag100
Scenario Outline: Update the User Address custom price settings for both one time and refill
When Click on the product details button
And Select the product from dropdown
And Click on add product button
And Select the Both toggle button
