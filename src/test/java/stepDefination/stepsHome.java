...
//        String relativePath = System.getProperty("user.dir") + "/ExtentReports";
//
//        // Create a File object with the relative path
//        File reportFile = new File(relativePath);
//
//        // Check if the file exists and delete it
//        if (reportFile.exists()) {
//            reportFile.delete();
//            System.out.println("Old Extent Report deleted.");
//        } else {
//            System.out.println("No old Extent Report found to delete.");
//        }
//    }
