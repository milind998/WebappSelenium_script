...
public class stepUsers {
	...
	public static UsersPage user = new UsersPage(Home.ldriver);
	...
	public void validate_the_users() {
		//  assertion for name
		WebDriverWait wait = new WebDriverWait(Home.ldriver, 3);
	...
	@When("Click on update buttons")
	public void click_on_update_buttons() {
...
//// common for deposit and custom amount and deposit
	...
	public void click_on_the_maximum_button() {
		...
		try {
			...
			WebElement errorMessage = Home.ldriver.findElement(By.className("Toastify__toast-body"));
